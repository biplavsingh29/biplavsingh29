...
#Create a Databases and connect them
...
'''
#Create a Update Function to update a Records
...
def edit():
    ...
    editor.iconbitmap("C:/Users/lenovo/Desktop/python/img/Bunny.ico")
    ...
    # Create Gobal Variables for Text box Names
    ...
    # Create an Save Button to sava a record
...
# Create Submit Box for Database
def submit():
    #Create a Databases and connect them
    conn = sqlite3.connect('address_book.db')
...
edit_btn.grid(row=15, column=0, columnspan=2, padx=10, pady=10, ipadx=145)
